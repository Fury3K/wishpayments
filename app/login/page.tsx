                    ...
                    <div className="card w-full max-w-md bg-white/70 backdrop-blur-xl shadow-2xl border border-white/40 overflow-hidden">
                        <div className="card-body p-8">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-slate-500 mt-1">Login to track your financial goals.</p>
                            </div>
                            ...
                            <form className="space-y-4" onSubmit={handleLogin}>
                                ...
                                <div className="form-control">
                                    ...
                                    <label className="label">
                                        <a href="#" className="label-text-alt link link-hover text-violet-600 font-medium">Forgot password?</a>
                                    </label>
                                </div>
                            ...
                            <div className="text-center mt-8 text-sm text-slate-500">
                                ...
                                <Link href="/register" className="link link-primary font-bold text-violet-600 no-underline hover:underline">
                                    Sign up
                                </Link>
                            </div>
                        </div>
